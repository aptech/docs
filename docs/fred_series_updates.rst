...
.. function:: x = fred_series_updates([, ...])
    ...
    :param filter_value: Limit results by geographic type of economic data series; namely 'macro', 'regional', and 'all'. optional, default: 'all' meaning no filter.
         One of the values: 'macro', 'regional', 'all''macro' limits results to macroeconomic data series.  In general, these are series for entire countries that are not subregions of the United States.
