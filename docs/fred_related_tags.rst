...
Format
----------------
.. function:: x = fred_related_tags(tag_names[, ...])

    :param tag_names: A semicolon delimited list of tag names that series match all of. See the related request :func:`fred_tags`. required, no default value.
