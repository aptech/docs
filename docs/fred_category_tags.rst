...
.. function:: x = fred_category_tags(category_id[, ...])
    ...
    :param tag_names: A semicolon delimited list of tag names to only include in the response.  See the related request fred/category/related_tags. optional, no filtering by tag names by default
