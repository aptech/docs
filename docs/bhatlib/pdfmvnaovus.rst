...
Computes the gradient of the approximated cumulative distribution function (CDF) of a multivariate normal distribution using the one-variate univariate screening (OVUS) approach.

Format
----------------
.. function:: { w, gC, gcor } = pdfmvnaOVUS(a, rr, s)
