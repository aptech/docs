...
Approximates the cumulative distribution function (CDF) of a multivariate normal distribution using one-variate bivariate screening (OVBS) approach.

Format
----------------
.. function:: w = cdfmvnaOVBS(a, rr, s)
