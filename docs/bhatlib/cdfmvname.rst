...
Approximates the cumulative distribution function (CDF) of a multivariate normal distribution using the Moment Expansion (ME) approach.

Format
----------------
.. function:: w = cdfmvnaME(a, rr, s)
