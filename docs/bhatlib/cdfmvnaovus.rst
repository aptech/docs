...
Approximates the cumulative distribution function (CDF) of a multivariate normal distribution using the one-variate univariate screening (OVUS) approach.

Format
----------------
.. function:: w = cdfmvnaOVUS(a, rr, s)
