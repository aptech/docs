...
Computes the gradient of the approximated cumulative distribution function (CDF) of a multivariate normal distribution using the Trinh and Genz's approximation with bivariate screening (TGBME) approach.

Format
----------------
.. function:: { w, gC, gcor } = pdfmvnaTGBME(a, rr, s)
