...
Approximates the cumulative distribution function (CDF) of a multivariate normal distribution using bivariate moment expansion (BME) approach.

Format
----------------
.. function:: w = cdfmvnaBME(a, rr, s)
