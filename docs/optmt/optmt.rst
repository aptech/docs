...
Format
----------------
.. function:: out = optmt(&fnc, par [,..., c1])

    :param &fnc: Pointer to a procedure that computes the function to be minimized.
    :type &fnc: pointer
    ...
    :return out1: An instance of a :class:`optmtResults` structure. Contains the results of the nonlinear programming problem solution, including parameter estimates, function evaluations, and detailed information about constraints handling and optimization process. The :class:`optmtResults` structure includes:
