...
.. function:: x = fred_series_search_related_tags(series_search_text, tag_names[, ...])
    ...
    :param tag_names: A semicolon delimited list of tag names that series match all of.  See the related request fred/series/search/tags. required, no default value.
