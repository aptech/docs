...
See the related request :func:`fred_related_tags`.
...
.. function:: x = fred_tags([, ...])
    ...
    :param tag_names: A semicolon delimited list of tag names to only include in the response. See the related request :func:`fred_related_tags`. optional, no filtering by tag names by default
